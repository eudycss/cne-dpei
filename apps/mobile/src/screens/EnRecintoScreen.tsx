...
export function EnRecintoScreen() {
  const { user, logout } = useAuth();
  return (
    <View style={styles.container}>
      <AppBar subtitle="En el recinto" />
      <View style={styles.body}>
        <View style={styles.iconCircle}>
          <Text style={styles.icon}>✓</Text>
        </View>
        <Text style={styles.title}>Llegada confirmada</Text>
        <Text style={styles.subtitle}>
          Hola {user?.nombres}, tu llegada al recinto y la recepción de los kits están
          registradas.
        </Text>
        <Text style={styles.message}>
          La pantalla de registro de salida del recinto estará disponible en la siguiente fase.
        </Text>
